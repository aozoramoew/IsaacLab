...
from .r2_shadow_hand_over_env_cfg import R2ShadowHandOverEnvCfg


class R2ShadowHandOverEnv(DirectMARLEnv):
    cfg: R2ShadowHandOverEnvCfg

    def __init__(self, cfg: R2ShadowHandOverEnvCfg, render_mode: str | None = None, **kwargs):
